...
<aside id="logo-sidebar" class="top-0 left-0 z-40 w-76 h-screen transition-transform -translate-x-full sm:translate-x-0 border-x-2 border-gray-200" aria-label="Sidebar">
    <div class="h-full px-4 py-10 dark:bg-gray-800">
        ...
        <div class="space-y-96">
            <ul class="space-y-4 font-medium px-1">
                <li>
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <span>
                                <img src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQJeZIThDjAfoSa4tzLwHDrx-xzp1Ye6Dd8AFhLoJqUzfRZS7da" alt="Profile" class="w-8 h-8 rounded-full">
                            </span>
            ...
            <ul class="space-y-4 font-medium px-1 justify-self-end">
                <li>
